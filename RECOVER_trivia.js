...
lib.ssMetadata = [
		{name:"RECOVER_trivia_atlas_", frames: [[0,0,802,74],[309,76,307,62],[0,76,307,62],[804,0,158,32]]}
];
...
(lib.black = function() {
	this.spriteSheet = ss["RECOVER_trivia_atlas_"];
	this.gotoAndStop(0);
...
(lib.RECOVER_trivia = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		["מהי עיר הבירה של מדינת ישראל?","ירושליים","עכו","קיסריה","תל אביב","ffft"],
		["מי אמרה 'אם אין לכם, שיאכלו עוגות'?","המלכה ויקטוריה","מרי אנטואנט","מרי מלכת הסקוטים","מרגרט תאצ'ר","ftff"],
		...
		["דונאלד טראמפ הוא נשיא מספר ___ של ארצות הברית?","דגניה","כנרת","משמורת","צהלים","tfff"],
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/RECOVER_trivia_atlas_.png?1523618544566", id:"RECOVER_trivia_atlas_"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1523618544586", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1523618544586", id:"sdk/anwidget.js"},
		{src:"components/ui/src/label.js?1523618544586", id:"an.Label"},
		{src:"components/ui/src/css.js?1523618544586", id:"an.CSS"}
	],
	preloads: []
};
